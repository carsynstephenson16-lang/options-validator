...
| 37 | Dashboard presentation fixes — seven fixes from the 2026-09-04 review (DR-1..DR-4, DR-6 sentence-only, DR-7, DR-8a, DR-9: Mission Control as-of/shares/H7-paused/achievements, board gap-sentence truth + tracker receipt order + notice aging, job-health digest cache symlink); DR-5/DR-5b (GREEN-fraction tilt; rv21 badges on Schwab cards) held for owner ruling; DR-8b (event-chip dedupe) held for the visual-redesign brief | Reserved 2026-09-04 by the options-validator status/dashboard review session; `docs/superpowers/plans/2026-09-04-37-dashboard-presentation-fixes-codex-brief.md` committed together with this row (rev 4 after three adversarial review rounds, receipts `reports/2026-09-04-brief-37-adversarial-review-round{1,2,3}.md`). Highest number on disk at reservation time was 36; `ls` performed immediately before numbering; no untracked drafts present | Reserved and tracked together |
