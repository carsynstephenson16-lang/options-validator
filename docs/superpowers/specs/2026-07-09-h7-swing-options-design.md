...
and **v1.3 (`6faa4945`, 2026-07-11; Repo-verified): the 2018-2026 historical diagnostic is
...
(`H7_HISTORICAL_WITHDRAWAL_HASH`). Audit receipts v1-v4
(`reports/h7_audit/`) are preserved historical BLOCK artifacts; v4 was the
final pre-roadmap snapshot and is not regenerated after later source changes.
