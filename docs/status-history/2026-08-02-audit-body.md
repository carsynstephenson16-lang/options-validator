<!-- Verbatim move on 2026-09-15 of PROJECT_STATE.md lines 182-1043 (the 2026-08-02 audit body, sections 1-15, with every later closure annotation). Byte-for-byte; nothing edited. Section numbers referenced by other docs (§3.1, §6, §9, §13, Q4 ...) are unchanged. -->
