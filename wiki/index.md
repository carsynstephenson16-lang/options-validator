...
- [Automation](automation.md) - the 09:09 daily ritual's step order and fail-closed gates, 5x/day intraday capture, the repo-RAG health agent, which LaunchAgents are actually loaded, and why it all runs from the ops checkout.
