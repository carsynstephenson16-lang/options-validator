...
def load_cached_chain(
    ...
    *,
    ...
    `verdict_bearing=True` additionally requires schema v2. Legacy v1 rows
    remain readable for display, but cannot become verdict evidence because
    their discarded timestamps and provenance fields cannot be reconstructed.
